...
-- AddForeignKey
ALTER TABLE `ams_sorted` ADD CONSTRAINT `ams_sorted_choice1Id_fkey` FOREIGN KEY (`choice1Id`) REFERENCES `ams_step_choice`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `ams_sorted` ADD CONSTRAINT `ams_sorted_choice2Id_fkey` FOREIGN KEY (`choice2Id`) REFERENCES `ams_step_choice`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `ams_fresher` ADD CONSTRAINT `ams_fresher_serial_fkey` FOREIGN KEY (`serial`) REFERENCES `ams_step_profile`(`serial`) ON DELETE RESTRICT ON UPDATE CASCADE;
