...
CREATE TABLE `ais_student` (
    ...
    `semesterDone` INTEGER NOT NULL,
    `creditDone` INTEGER NULL,
    `entrySemesterNum` INTEGER NOT NULL,
    `entryGroup` ENUM('GH', 'INT') NOT NULL DEFAULT 'GH',
    `entryDate` DATETIME NOT NULL,
    `exitDate` DATETIME NULL,
    `deferStatus` BOOLEAN NOT NULL DEFAULT false,
    `completeStatus` BOOLEAN NOT NULL DEFAULT false,
    `completeType` ENUM('GRADUATION', 'RASTICATED', 'FORFEITED', 'DEAD', 'DISMISSED') NOT NULL,
    ...
    `instituteEmail` VARCHAR(191) NULL,
...
CREATE TABLE `ais_session` (
    ...
    `registerStart` DATETIME(3) NOT NULL,
    `registerEnd` DATETIME(3) NOT NULL,
    `registerEndLate` DATETIME(3) NOT NULL,
    `registerPause` BOOLEAN NOT NULL DEFAULT false,
    `orientStart` DATETIME(3) NOT NULL,
    `orientEnd` DATETIME(3) NOT NULL,
    `lectureStart` DATETIME(3) NOT NULL,
    `lectureEnd` DATETIME(3) NOT NULL,
    `examStart` DATETIME(3) NOT NULL,
    `examEnd` DATETIME(3) NOT NULL,
    `entryStart` DATETIME(3) NOT NULL,
    `entryEnd` DATETIME(3) NOT NULL,
...
CREATE TABLE `ais_sheet` (
    ...
    `programId` VARCHAR(191) NOT NULL,
    `majorId` VARCHAR(191) NULL,
    `assignStaffId` VARCHAR(191) NOT NULL,
    `assessorId` VARCHAR(191) NULL,
    `certifierId` VARCHAR(191) NULL,
    `semesterNum` INTEGER NOT NULL,
    `sessionMode` VARCHAR(50) NOT NULL,
    `studentCount` INTEGER NOT NULL,
    `completeRatio` DOUBLE NOT NULL,
...
CREATE TABLE `ais_resit` (
    `id` VARCHAR(191) NOT NULL,
    `resitSessionId` VARCHAR(191) NOT NULL,
    `trailSessionId` VARCHAR(191) NOT NULL,
    `registerSessionId` VARCHAR(191) NOT NULL,
    `schemeId` VARCHAR(191) NOT NULL,
    `courseId` VARCHAR(191) NOT NULL,
    `indexno` VARCHAR(50) NOT NULL,
    `semesterNum` INTEGER NOT NULL,
    `totalScore` INTEGER NOT NULL,
    `approveScore` BOOLEAN NOT NULL DEFAULT true,
...
CREATE TABLE `ams_stage` (
    ...
    `title` VARCHAR(350) NOT NULL,
    `type` ENUM('SINGLE', 'MULTIPLE') NULL,
    `status` BOOLEAN NOT NULL DEFAULT true,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
...
CREATE TABLE `ams_voucher` (
    ...
    `applicantPhone` VARCHAR(10) NOT NULL,
...
CREATE TABLE `ams_sorted` (
    ...
    `categoryId` VARCHAR(191) NULL,
    `sellType` INTEGER NOT NULL,
    `choice1Id` VARCHAR(191) NOT NULL,
    `choice2Id` VARCHAR(191) NOT NULL,
    `title` VARCHAR(350) NOT NULL,
    `gradeValue` INTEGER NOT NULL,
    `classValue` INTEGER NOT NULL,
...
CREATE TABLE `ams_step_result` (
    `id` VARCHAR(191) NOT NULL,
    `serial` INTEGER NOT NULL,
    `examCategoryId` VARCHAR(191) NULL,
...
CREATE TABLE `hrs_staff` (
    `staffNo` INTEGER NOT NULL AUTO_INCREMENT,
    `titleId` VARCHAR(191) NULL,
    `fname` VARCHAR(255) NOT NULL,
    `mname` VARCHAR(350) NULL,
    `lname` VARCHAR(255) NOT NULL,
...
-- AddForeignKey
ALTER TABLE `ais_student` ADD CONSTRAINT `ais_student_programId_fkey` FOREIGN KEY (`programId`) REFERENCES `ais_program`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `ais_structure` ADD CONSTRAINT `ais_structure_unitId_fkey` FOREIGN KEY (`unitId`) REFERENCES `unit`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `ais_structure` ADD CONSTRAINT `ais_structure_majorId_fkey` FOREIGN KEY (`majorId`) REFERENCES `ais_major`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `ais_resit` ADD CONSTRAINT `ais_resit_resitSessionId_fkey` FOREIGN KEY (`resitSessionId`) REFERENCES `ais_resession`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `ais_resit` ADD CONSTRAINT `ais_resit_registerSessionId_fkey` FOREIGN KEY (`registerSessionId`) REFERENCES `ais_session`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `ams_voucher` ADD CONSTRAINT `ams_voucher_vendorId_fkey` FOREIGN KEY (`vendorId`) REFERENCES `ams_vendor`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `ams_fresher` ADD CONSTRAINT `ams_fresher_billId_fkey` FOREIGN KEY (`billId`) REFERENCES `fms_bill`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `ams_step_result` ADD CONSTRAINT `ams_step_result_examCategoryId_fkey` FOREIGN KEY (`examCategoryId`) REFERENCES `ams_exam_category`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `ams_step_employment` ADD CONSTRAINT `ams_step_employment_titleId_fkey` FOREIGN KEY (`titleId`) REFERENCES `title`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
